    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav m-auto">
                <li class="nav-item">
                    {{-- <a class="nav-link {{ request()->routeIs('home') ? 'active' : '' }}" aria-current="page" href="{{ route('home') }}">หน้าแรก</a> --}}
                </li>
                @if(Auth::check())
                    {{-- <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('url') ? 'active' : '' }}" href="{{ route('url') }}">ลิงค์</a>
                    </li> --}}
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('report') ? 'active' : '' }}" href="{{ route('report.index') }}">รายงาน</a>
                    </li>
                @endif
            </ul>
            ...
            <ul class="menu_icon d-flex flex-wrap">
                @if(!auth::check())
                    ...
                    {{-- <li>
                        <a class="common_btn" href="{{ route('register') }}">สมัครสมาชิก</a>
                    </li> --}}
                @elseif (auth::user()->role === 'admin')
                    <li>
                        <a class="common_btn" href="{{ route('admin.dashboard') }}">Admin Dashboard</a>
                    </li>
                @else
                    <li>
                        <a class="common_btn" href="{{ route('login') }}">Dashboard</a>
                    </li>
                @endif
            </ul>
        </div>
